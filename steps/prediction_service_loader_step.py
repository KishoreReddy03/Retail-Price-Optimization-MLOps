...
from zenml.services import BaseService  # Updated import


@step(enable_cache=False)
def bentoml_prediction_service_loader(
    pipeline_name: str, step_name: str, model_name: str
) -> BaseService:  # Replaced BentoMLDeploymentService with BaseService
    ...
    return cast(BaseService, services[0])  # Updated return type
